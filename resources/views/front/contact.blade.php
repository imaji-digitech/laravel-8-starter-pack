...
<!-- Mirrored from preview.colorlib.com/theme/aznews/contact.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 07:10:32 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="{{asset('front/img/logo/loder.html')}}" alt="">
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="main-menu d-none d-md-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="tausiyah.blade.php">Tausiyah</a></li>
                                            <li><a href="event.blade.php">Event</a></li>
    ...
    <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="https://preview.colorlib.com/theme/aznews/contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                            <div class="row">
                                <div class="col-12">
                         ...
                         <div class="single-footer-caption">
                             <div class="single-footer-caption">
                                 ...
                                 <div class="footer-logo">
                                     <a href="index.html"><img src="('front/img/logo/logo2_footer.png" alt=""></a>
                                 </div>
...
<!-- Mirrored from preview.colorlib.com/theme/aznews/contact.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Dec 2020 07:10:35 GMT -->
</html>
