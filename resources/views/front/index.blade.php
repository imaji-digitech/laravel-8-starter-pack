                            ...
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>
                                        ...
                                        <li><img src="{{assets('front/img/icon/header_icon1.png')}}" alt="">Tuesday, 18th June, 2019</li>
                                    </ul>
                                </div>
                                ...
                                <div class="main-menu d-none d-md-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="tausiyah.blade.php">Category</a></li>
                                            <li><a href="about.html">About</a></li>
                                            <li><a href="event.blade.php">Latest News</a></li>
